...
public final class ExpenseManagerContract {
    ...
    public static class TransactionEntry implements BaseColumns {
        ...
        public static final String SQL_CREATE_ENTRY = "create table " + TABLE_NAME + " (" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_DATE + " REAL, " + COLUMN_ACCOUNT_NO + " TEXT, " + COLUMN_EXPENSE_TYPE + " INTEGER, " + COLUMN_AMOUNT + " REAL)";
